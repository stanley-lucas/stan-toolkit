# Development Standards — Stanley Mairon

> This file lives in `~/.claude/CLAUDE.md` and applies to every project.
> Project-specific conventions go in the project's own `CLAUDE.md`.
...
Use the language default formatter. Don't discuss style beyond that:
